...
public class BasicShaderBuilder implements SimpleShaderBuilder {
	 ...
	 * 
	 * @see
	 * ch.epfl.sweng.androfoot.rendering.shaders.SimpleShaderBuilder#setColor
	 ...
	 * 
	 * @see
	 * ch.epfl.sweng.androfoot.rendering.shaders.SimpleShaderBuilder#setProjMatrix
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ch.epfl.sweng.androfoot.rendering.shaders.SimpleShaderBuilder#
	 * setTransfoMatrix(com.badlogic.gdx.math.Matrix4)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * ch.epfl.sweng.androfoot.rendering.shaders.SimpleShaderBuilder#render()
	 */
	@Override
