...
public class LocalPlayScreen implements Screen {
    ...
    private TextButton
        buttonStart = new TextButton(BUTTON_STRING_START, skin);
    ...
    public void show() {
        ...
        table.add(buttonStart).size(BUTTON_X_PADDING+BUTTON_STRING_START.length()*BUTTON_X_SIZE_PER_LETTER,BUTTON_Y_SIZE).padBottom(WIDGET_Y_PADDING).row();
