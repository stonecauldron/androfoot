...
public class CreditsScreen implements Screen {
	private static final String BUTTON_STRING_BACK = "Back";
	private static final String LABEL_CREDITS = "Credits";
	private static final String LABEL_MEMBERS = "Guillaume Leclerc\n"
												+ "Mathvey Khokhlov\n"
												+ "Pedro Caldeira\n"
												+ "Sidney Barthe\n"
												+ "Aurelien Farine\n"
	...
	private Label title = new Label(LABEL_CREDITS, skin);
	private Label members = new Label(LABEL_MEMBERS, skin);
	...
	public void show() {
		...
		table.add(buttonBack)
				.size(BUTTON_X_PADDING + BUTTON_STRING_BACK.length() * BUTTON_X_SIZE_PER_LETTER,
						BUTTON_Y_SIZE)
