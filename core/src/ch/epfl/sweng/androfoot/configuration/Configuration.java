 ...
 *         or not...). They will be set in the settings and before starting a game.
 *         They can be accessed from anywhere using getters. All these values
 *         are loaded as preferences when the first instance is created and can be
 *         saved using the savePreferences method.
 */
public final class Configuration {
	...
	private Configuration() {
		if (ONEINSTANCE != null) {
			...
			mSensitivity = mPrefs.getInteger("SENSITIVITY", DEFAULT_SENSITIVITY);
			...
			mPlayerOneNbAttackers = mPrefs.getInteger("PLAYER_ONE_NB_ATTACKERS", DEFAULT_NB_OF_ATTACKERS);
			mPlayerTwoNbAttackers = mPrefs.getInteger("PLAYER_TWO_NB_ATTACKERS", DEFAULT_NB_OF_ATTACKERS);
