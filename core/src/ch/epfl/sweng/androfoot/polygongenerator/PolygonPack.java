...
/**
 * A polygonGenerator aggregator It is a kind of
 * {@code Map<String, PolygonGenerator>} You can't add a new sub polygon after
 * the vertexes have been generated
 * 
...
class PolygonPack extends AbstractPolygonGenerator implements PolygonMap {
	 ...
	 * 
	 * @param key
	 *            the key of the Polygon
	 * @param generator
	 *            the generator of the polygon
	 * @throws RuntimeException
	 *             when the polygon has already been generated at least onece.
	 */
