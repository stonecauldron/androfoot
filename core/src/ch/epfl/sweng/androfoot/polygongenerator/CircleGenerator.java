...
/**
 * Generate a polygon wich is an approximation of a circle It can also generate
 * subparts of circles This is a circular Polygon, that means the the first and
...
public class CircleGenerator extends AbstractPolygonGenerator {
	...
	/**
	 * The generator built will return a polygon which is an approximation of a
	 * circle of radius 1
	 * 
	 * @param nbSegments
	 *            the number of segments in the polygon (number of vertexes -1)
	 */
	 ...
	 *            the number of segments in the polygon (number of vertexes -1)
	 * @param angleFrom
	 *            the angle to start the sub-circle
	 * @param angleTo
	 *            than angle to stop the sub-circle
	 * @param angleType
	 *            the unit used for the last two arguments
	 */
	...
	protected float[] generate() {
		...
		if (from - to == 0) {
			angleStep = PolygonUtils.MAX_ANGLE_RADIAN / segments;
		}
